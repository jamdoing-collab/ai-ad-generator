...
// 物料统一数据源（前后端共享唯一来源）
const MATERIALS = [
  { key: 'door', name: '门头招牌', icon: '🏪', desc: 'Ultra-wide horizontal signboard design layout, large headline area, minimal but strong text hierarchy, very high long-distance readability, bold clean flat artwork for print production.', defaultW: 300, defaultH: 100, defaultAspectRatio: '3:1' },
  ...
  { key: 'menu', name: '餐饮菜单', icon: '🍜', desc: 'Restaurant menu flat layout, strong readability, clear category grouping, dish names and prices easy to scan, structured typography-first print-ready design.', defaultW: 21, defaultH: 30, defaultAspectRatio: '2:3' },
  { key: 'rollup', name: '易拉宝', icon: '🎞️', desc: 'Tall vertical promotional layout, clear top-middle-bottom structure, strong headline at top, central hero visual, supporting information and contact area at bottom, flat print-ready banner artwork.', defaultW: 80, defaultH: 200, defaultAspectRatio: '2:5' },
  { key: 'wall', name: '文化墙', icon: '🏢', desc: 'Wide horizontal modular information layout, multiple organized content blocks, suitable for corporate values, timeline, or culture messaging, flat large-format print-ready artwork.', defaultW: 300, defaultH: 150, defaultAspectRatio: '2:1' },
