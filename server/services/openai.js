...
const MATERIALS = [
  ...
  { key: 'door', name: '门头招牌', icon: '🏪', desc: 'Ultra-wide horizontal storefront signboard design layout, prominent brand name with large headline area, sub-headline or tagline area, structured multi-zone layout with clear visual weight distribution, decorative border lines or accent graphic elements, background texture or subtle gradient, strong visual hierarchy optimized for long-distance readability, professional commercial sign flat print-ready artwork.', defaultW: 300, defaultH: 100 },
